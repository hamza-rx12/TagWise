...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
        // on desactive csrf cr une utilise les tokens non pas les sessions ou les cookies
            ...
            .sessionManagement(session -> session
                .sessionCreationPolicy(SessionCreationPolicy.STATELESS))            // on verifie les proprietes d'authentification 
            .authenticationProvider(authenticationProvider)

package com.tagwise.backend.services;
...
public class AuthenticationService {
    ...
    public User signup(RegisterUserDto input) {
        User user = new User(input.getUsername(), passwordEncoder.encode(input.getPassword()), input.getFirstName(), input.getLastName(),input.getGender(), input.getRole(), input.getEmail());

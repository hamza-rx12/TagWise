  ...
  return (
    <div className="font-poppins antialiased">
      <div className="min-h-screen flex bg-gray-100">
        ...
        <button
          className="p-2 border-2 bg-white rounded-md border-gray-200 shadow-lg text-gray-500 focus:bg-teal-500 focus:outline-none focus:text-white fixed top-4 left-4 z-20 sm:hidden"
        ...
        {/* Fixed Sidebar */}
        <div
          className={`fixed top-0 left-0 h-screen bg-white shadow-xl px-3 w-[30px] md:w-60 transition-transform duration-300 ease-in-out z-10 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'
            } md:translate-x-0`}
        >
          <div className="space-y-6 md:space-y-10 mt-10">
            ...
            <div className="flex flex-col space-y-2">
              ...
              >
                ...
                <span>Annotators Management</span>
              </Link>
              <Link
                to="/admin/messages"
                className="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
              ...
              <button
                onClick={logout}
                className="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-red-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out text-left"
                aria-label="Logout"
              >
                <svg className="w-6 h-6 fill-current inline-block" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path
        ...
        <div className="ml-0 md:ml-60 flex-1 p-4 md:p-6">
...
// Export the layout-wrapped version
